...
\begin{figure}[htb]
  \centering
    \includegraphics[width=0.70\columnwidth]{images/top500/top500.pdf}%    \caption{Top500.}
    \label{fig:top500}
\end{figure}

\begin{figure}[htb]
  \centering
    \includegraphics[width=0.70\columnwidth]{images/top500/top30.pdf}%    \caption{Top30.}
    \label{fig:top30}
\end{figure}

Equilibrium index is 7 where the first 7 resources of the list are equal to the sum of all other 493 resources.
