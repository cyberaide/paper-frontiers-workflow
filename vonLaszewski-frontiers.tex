...
% Check if compiling with Overleaf
\ifdefined\OVERLEAF
    % Code for Overleaf
    This document is compiled on Overleaf.
\else
    % Code for local or other environments
    This document is compiled locally or on another platform.
\fi
